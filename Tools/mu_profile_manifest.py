...
# The table lives in Platform/Profiles.py, because Platform/*/PlatformBuild.py
# needs the same answer when it turns a profile into -D NTASI_* defines. It used
# to be written out here too: thirty profiles, fourteen shared fields, kept
# equal by hand. manifest_view() applies the same defaults the build applies and
# returns the shape this file wants -- bools, NTAS00xx, integer pipe masks.
PROFILES = Profiles.manifest_view(TARGET_NAME)
REQUIRED_FFS = {
