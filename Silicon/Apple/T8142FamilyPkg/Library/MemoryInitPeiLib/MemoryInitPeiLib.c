...
#define MAP_DEVICE_RANGE(Base, Size)                                       \
  ...
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_3_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_3_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_4_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_4_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_5_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_5_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_6_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_6_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_7_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_7_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_8_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_8_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_9_BASE,  APPLE_CORE_SYSTEM_MMIO_RANGE_9_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_10_BASE, APPLE_CORE_SYSTEM_MMIO_RANGE_10_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_11_BASE, APPLE_CORE_SYSTEM_MMIO_RANGE_11_SIZE);
  MAP_DEVICE_RANGE (APPLE_CORE_SYSTEM_MMIO_RANGE_12_BASE, APPLE_CORE_SYSTEM_MMIO_RANGE_12_SIZE);

  //
  // PCIe. Per the note above these really want nGnRE rather than nGnRnE; that
  // distinction is not yet expressible here, so they use the same attribute as
  // the core ranges for now, exactly as the other SoC packages do.
  //
  //
  // ECAM / config space.
  //
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_1_BASE, APPLE_PCIE_MMIO_RANGE_1_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_2_BASE, APPLE_PCIE_MMIO_RANGE_2_SIZE);

  //
  // BAR windows. Decoded from the controllers' `ranges` properties -- see the
  // memory map header. Without these, enumerating PCIe and placing a BAR would
  // fault.
  //
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_3_BASE, APPLE_PCIE_MMIO_RANGE_3_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_4_BASE, APPLE_PCIE_MMIO_RANGE_4_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_5_BASE, APPLE_PCIE_MMIO_RANGE_5_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_6_BASE, APPLE_PCIE_MMIO_RANGE_6_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_7_BASE, APPLE_PCIE_MMIO_RANGE_7_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_8_BASE, APPLE_PCIE_MMIO_RANGE_8_SIZE);
  MAP_DEVICE_RANGE (APPLE_PCIE_MMIO_RANGE_9_BASE, APPLE_PCIE_MMIO_RANGE_9_SIZE);
