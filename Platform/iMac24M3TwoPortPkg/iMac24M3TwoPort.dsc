...
[Defines]
  DEFINE T8122_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = iMac24M3TwoPort
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j433 <build>
  ...
  OUTPUT_DIRECTORY               = Build/iMac24M3TwoPort-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iMac24M3TwoPortPkg/iMac24M3TwoPort.fdf
  ...
  #   BLD_*_NTASI_T6020_J433_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x8122
  # This machine's SoC, from its device tree compatible. The family
  # package pins the base part of the family; a Max or Ultra is not it.
  ...
  # Boot Windows deterministically. The J433 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"iMac (24-inch, 2x USB-C, M3, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J433"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"iMac (24-inch, 2x USB-C, M3, 2023) (J433)"
  #
...
!include iMacFamilyPkg/iMacFamilyPkg.dsc.inc
!include T8122FamilyPkg/T8122FamilyPkg.dsc.inc
