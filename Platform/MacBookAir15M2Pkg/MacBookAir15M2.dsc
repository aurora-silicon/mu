...
[Defines]
  DEFINE T811X_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacBookAir15M2
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j415 <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookAir15M2-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookAir15M2Pkg/MacBookAir15M2.fdf
  ...
  #   BLD_*_NTASI_T6020_J415_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J415s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Air (15-inch, M2, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J415"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Air (15-inch, M2, 2023) (J415)"
  #
