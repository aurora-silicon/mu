# Generated by Tools/add-machine.py from Asahi's t8112-j415.dts.
...
#
# @file
# stuart settings for the MacBookAir15M2 (J415s) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J415_HOMOGENEOUS_EFFICIENCY", "0", "Default")
