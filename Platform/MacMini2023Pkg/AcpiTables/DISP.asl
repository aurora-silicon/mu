/** @file
  J474s internal display adapter ACPI device for the AppleDisplay WDDM
  display driver (rungs (a) and (b) of docs/j474s-display-driver.md).
  ...
  The _DSD properties are the pinned J474s geometry, provided ONLY as a
  ...
  Provenance:
    ...
    Panel 302 x 196 mm: Asahi linux-asahi t6020-j474s.dts panel node; also
