/** @file
  J474s AOP (Always-On Processor) internal microphone array ACPI device.
  ...
  Tests/test_j474s_media_acpi_contract.py pins this file against that C table.
  ...
  > wrong here.  tools/verify-j474s-av-adt.py asserts the disagreement so it
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j474s.dts:34-37
    ...
    The pinned live-ADT capture sha256 93d96b4a..., asserted by
      tools/verify-j474s-av-adt.py --section mic (51 checks)
        ...
        Device (AOPA)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // shipped driver uses its compiled-in J474s fallback and
            ...
            // missing APDM as "use the compiled-in J474s table", records
