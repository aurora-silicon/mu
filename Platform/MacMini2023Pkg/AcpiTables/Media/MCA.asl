/** @file
  J474s MCA audio complex ACPI device.
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t602x-j414-j416.dtsi
      (J474s GPIO overrides: SDZ pinctrl_ap 57, amp IRQ 58, jack IRQ 59)
  ...
  docs/j474s-audio-bringup.md section 8 before changing anything here.
    ...
    Scope (\_SB)
    {
        Device (MCA0)
        {
            ...
            Name (_CRS, ResourceTemplate ()
            {
                ...
                // the live ADT and tools/verify-j474s-gsiv-allocation.py
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // tools/verify-j474s-av-adt.py.  Where Apple's ADT and
                    // Asahi's hand-written Linux DT disagree, BOTH are
                    // recorded rather than one being silently preferred.
                    //
                    // Only three MCA cluster nodes are instantiated on J474s
