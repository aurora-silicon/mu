/** @file
  J474s (M2 Pro / T6020) FaceTime camera ISP coprocessor ACPI device.
  ...
  Tests/test_j474s_media_acpi_contract.py machine-checks that the _CRS window
  ...
  does not silently break the camera.  tests/test_j474s_av_memory_contract.py
  pins it.
  ...
  Provenance:
    ...
    the pinned J474s live ADT capture, sha256 93d96b4a...
    docs/j474s-camera-isp-bringup.md
...
DefinitionBlock ("ISP.aml", "SSDT", 0x02, "Apple", "J414ISP", 0x00000001)
{
    Scope (\_SB)
    {
        Device (ISP0)
        {
            ...
            // they exist so that tools/verify-j474s-av-adt.py and a human
