...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/MacMini2023-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacMini2023Pkg/MacMini2023.fdf
  ...
  #   BLD_*_NTASI_T6020_J474S_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J474s SSD dual-boots Fedora, whose
