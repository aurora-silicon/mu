# Generated by Tools/add-machine.py from Asahi's t8112-j493.dts.
...
#
# @file
# stuart settings for the MacBookPro13M2 (J493s) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J493_HOMOGENEOUS_EFFICIENCY", "0", "Default")
