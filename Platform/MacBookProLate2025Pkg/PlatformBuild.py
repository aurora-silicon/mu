...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("MacBookProLate2025Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('MacBookProLate2025', 'gcc_aarch64_linux', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("MacBookProLate2025Pkg/MacBookProLate2025.dsc", {})

    def GetName(self):
        return "MacBookProLate2025"
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "MacBookProLate2025Pkg/MacBookProLate2025.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "MacBookProLate2025", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "MacBookProLate2025Pkg/MacBookProLate2025.dsc", "Platform Hardcoded")
