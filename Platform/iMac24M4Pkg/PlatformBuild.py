# Generated by Tools/add-machine.py from Asahi's t8132-j624.dts.
...
#
# Generated by Tools/add-machine.py from Asahi's t6020-j624.dts.
# Apple iMac (24-inch, 4x USB-C, M4, 2024)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the iMac24M4 (J624) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J624_HOMOGENEOUS_EFFICIENCY", "0", "Default")
