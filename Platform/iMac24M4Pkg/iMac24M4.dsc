...
[Defines]
  DEFINE T8132_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = iMac24M4
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j624 <build>
  ...
  #
  DEFINE NTASI_SOC_HAS_PCIE = 0

  PLATFORM_GUID                  = d70b31ca-2cbc-433b-885f-b8bbda409959
  PLATFORM_VERSION               = 1.0
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/iMac24M4-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iMac24M4Pkg/iMac24M4.fdf
  ...
  #   BLD_*_NTASI_T6020_J624_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x8132
  # This machine's SoC, from its device tree compatible. The family
  # package pins the base part of the family; a Max or Ultra is not it.
  ...
  # Boot Windows deterministically. The J624 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"iMac (24-inch, 4x USB-C, M4, 2024)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J624"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"iMac (24-inch, 4x USB-C, M4, 2024) (J624)"
  #
...
!include T8132FamilyPkg/T8132FamilyPkg.dsc.inc
