# Generated by Tools/add-machine.py from Asahi's t8112-j473.dts.
...
#
# Generated by Tools/add-machine.py from Asahi's t6020-j473.dts.
# Apple Mac mini (M2, 2023)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the MacMini2023M2 (J473) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J473_HOMOGENEOUS_EFFICIENCY", "0", "Default")
