...
[Defines]
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j473 <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacMini2023M2-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacMini2023M2Pkg/MacMini2023M2.fdf
  ...
  #   BLD_*_NTASI_T6020_J473_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J473 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac mini (M2, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J473"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac mini (M2, 2023) (J473)"
  #
