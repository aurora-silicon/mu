# Generated by Tools/add-machine.py from Asahi's t8103-j456.dts.
# Apple iMac (24-inch, 4x USB-C, M1, 2021)
#
...
#
# Generated by Tools/add-machine.py from Asahi's t6020-j456.dts.
# Apple iMac (24-inch, 4x USB-C, M1, 2021)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the iMac24Late2021 (J456) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J456_HOMOGENEOUS_EFFICIENCY", "0", "Default")
