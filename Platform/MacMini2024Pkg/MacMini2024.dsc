...
[Defines]
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j773g <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacMini2024-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacMini2024Pkg/MacMini2024.fdf
  ...
  #   BLD_*_NTASI_T6020_J773G_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J773g SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac mini (M4, 2024)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J773g"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac mini (M4, 2024) (J773g)"
  #
