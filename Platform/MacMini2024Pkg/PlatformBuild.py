# Generated by Tools/add-machine.py from Asahi's t8132-j773g.dts.
...
#
# Generated by Tools/add-machine.py from Asahi's t6020-j773g.dts.
# Apple Mac mini (M4, 2024)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the MacMini2024 (J773g) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J773G_HOMOGENEOUS_EFFICIENCY", "0", "Default")
