/** @file
  J180d AOP (Always-On Processor) internal microphone array ACPI device.
  ...
  > wrong here.  tools/verify-j180d-av-adt.py asserts the disagreement so it
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j180d.dts:34-37
    ...
    The pinned live-ADT capture sha256 93d96b4a..., asserted by
      tools/verify-j180d-av-adt.py --section mic (51 checks)
        ...
        Device (AOPA)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // shipped driver uses its compiled-in J180d fallback and
            ...
            // missing APDM as "use the compiled-in J180d table", records
