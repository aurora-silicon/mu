/** @file
  J180d internal display adapter ACPI device for the AppleDisplay WDDM
  display driver (rungs (a) and (b) of docs/j180d-display-driver.md).
  ...
  The _DSD properties are the pinned J180d geometry, provided ONLY as a
  ...
  Provenance:
    ...
    Panel 302 x 196 mm: Asahi linux-asahi t6020-j180d.dts panel node; also
