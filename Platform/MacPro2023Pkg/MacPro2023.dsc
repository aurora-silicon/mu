...
[Defines]
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j180d <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacPro2023-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacPro2023Pkg/MacPro2023.fdf
  ...
  #   BLD_*_NTASI_T6020_J180D_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J180d SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac Pro (M2 Ultra, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J180d"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac Pro (M2 Ultra, 2023) (J180d)"
  #
...
!include MacProFamilyPkg/MacProFamilyPkg.dsc.inc
