...
[Defines]
  DEFINE T6032_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacStudioUltra2025
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j575d <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacStudioUltra2025-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacStudioUltra2025Pkg/MacStudioUltra2025.fdf
  ...
  #   BLD_*_NTASI_T6020_J575D_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6032
  # This machine's SoC, from its device tree compatible. The family
  # package pins the base part of the family; a Max or Ultra is not it.
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac Studio (M3 Ultra, 2025)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J575d"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac Studio (M3 Ultra, 2025) (J575d)"
  #
...
!include T6032FamilyPkg/T6032FamilyPkg.dsc.inc
