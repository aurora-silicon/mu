/** @file
  ...
  tools/verify-j416c-av-adt.py asserts the address and the register count.
  ...
  docs/j416c-audio-bringup.md section 8 before changing anything here.
    ...
    Scope (\_SB)
    {
        Device (MCA0)
        {
            ...
            Name (_CRS, ResourceTemplate ()
            {
                ...
                // the live ADT and tools/verify-j416c-gsiv-allocation.py
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // tools/verify-j416c-av-adt.py.  Where Apple's ADT and
