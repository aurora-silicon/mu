/** @file
  ...
  Tests/test_j416c_media_acpi_contract.py machine-checks that the _CRS window
  ...
  does not silently break the camera.  tests/test_j416c_av_memory_contract.py
  pins it.
  ...
  Provenance:
    ...
    docs/j416c-camera-isp-bringup.md
...
DefinitionBlock ("ISP.aml", "SSDT", 0x02, "Apple", "J416ISP", 0x00000001)
{
    Scope (\_SB)
    {
        Device (ISP0)
        {
            ...
            // they exist so that tools/verify-j416c-av-adt.py and a human
