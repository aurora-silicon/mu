/** @file
  J416s AOP (Always-On Processor) internal microphone array ACPI device.
  ...
  Tests/test_j416c_media_acpi_contract.py pins this file against that C table.
  ...
  > wrong here.  tools/verify-j416c-av-adt.py asserts the disagreement so it
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j416c.dts:34-37
      (apple,chassis-name = "J416", apple,machine-kind = "MacBook Pro")
    ...
    The pinned live-ADT capture sha256 93d96b4a..., asserted by
      tools/verify-j416c-av-adt.py --section mic (51 checks)
...
DefinitionBlock ("AOPA.aml", "SSDT", 0x02, "Apple", "J416AOPA", 0x00000001)
{
    Scope (\_SB)
    {
        Device (AOPA)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // shipped driver uses its compiled-in J416s fallback and
            ...
            // missing APDM as "use the compiled-in J416s table", records
