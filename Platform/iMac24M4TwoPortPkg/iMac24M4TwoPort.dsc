...
[Defines]
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j623 <build>
  ...
  OUTPUT_DIRECTORY               = Build/iMac24M4TwoPort-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iMac24M4TwoPortPkg/iMac24M4TwoPort.fdf
  ...
  #   BLD_*_NTASI_T6020_J623_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J623 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"iMac (24-inch, 2x USB-C, M4, 2024)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J623"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"iMac (24-inch, 2x USB-C, M4, 2024) (J623)"
  #
