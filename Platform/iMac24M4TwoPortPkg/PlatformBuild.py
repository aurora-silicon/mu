# Generated by Tools/add-machine.py from Asahi's t8132-j623.dts.
...
#
# Generated by Tools/add-machine.py from Asahi's t6020-j623.dts.
# Apple iMac (24-inch, 2x USB-C, M4, 2024)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the iMac24M4TwoPort (J623) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J623_HOMOGENEOUS_EFFICIENCY", "0", "Default")
