# Generated by Tools/add-machine.py from Asahi's t6034-j514m.dts.
# Apple MacBook Pro (14-inch, M3 Max, 14 CPU cores, Nov 2023)
#
...
#
# @file
# stuart settings for the MacBookPro14M3Max14Core (J514m) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J514M_HOMOGENEOUS_EFFICIENCY", "0", "Default")
