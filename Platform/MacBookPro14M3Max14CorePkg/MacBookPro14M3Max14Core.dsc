...
[Defines]
  DEFINE T6031_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacBookPro14M3Max14Core
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j514m <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro14M3Max14Core-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro14M3Max14CorePkg/MacBookPro14M3Max14Core.fdf
  ...
  #   BLD_*_NTASI_T6020_J514M_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6034
  ...
  # Boot Windows deterministically. The J514m SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (14-inch, M3 Max, 14 CPU cores, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J514m"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (14-inch, M3 Max, 14 CPU cores, Nov 2023) (J514m)"
  #
...
!include T6031FamilyPkg/T6031FamilyPkg.dsc.inc
