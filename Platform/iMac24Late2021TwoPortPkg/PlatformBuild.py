# Generated by Tools/add-machine.py from Asahi's t8103-j457.dts.
# Apple iMac (24-inch, 2x USB-C, M1, 2021)
#
...
# template (j474s) and have not been checked on this machine.
#
# Generated by Tools/add-machine.py from Asahi's t6020-j457.dts.
# Apple iMac (24-inch, 2x USB-C, M1, 2021)
#
# UNVERIFIED ON HARDWARE. This compiles against a proven SoC family
# package with this machine's own identity; nothing here has been
...
#
# @file
# stuart settings for the iMac24Late2021TwoPort (J457) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J457_HOMOGENEOUS_EFFICIENCY", "0", "Default")
