...
[Defines]
  DEFINE T810X_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = iMac24Late2021TwoPort
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j457 <build>
  ...
  OUTPUT_DIRECTORY               = Build/iMac24Late2021TwoPort-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iMac24Late2021TwoPortPkg/iMac24Late2021TwoPort.fdf
  ...
  #   BLD_*_NTASI_T6020_J457_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J457 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"iMac (24-inch, 2x USB-C, M1, 2021)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J457"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"iMac (24-inch, 2x USB-C, M1, 2021) (J457)"
  #
