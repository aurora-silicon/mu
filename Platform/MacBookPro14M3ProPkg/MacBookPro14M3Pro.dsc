...
[Defines]
  ...
  PLATFORM_NAME                  = MacBookPro14M3Pro
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j514s <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro14M3Pro-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro14M3ProPkg/MacBookPro14M3Pro.fdf
  ...
  #   BLD_*_NTASI_T6020_J514S_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J514s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (14-inch, M3 Pro, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J514s"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (14-inch, M3 Pro, Nov 2023) (J514s)"
  #
