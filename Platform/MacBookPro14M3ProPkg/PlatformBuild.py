# Generated by Tools/add-machine.py from Asahi's t6030-j514s.dts.
...
#
# @file
# stuart settings for the MacBookPro14M3Pro (J514s) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J514S_HOMOGENEOUS_EFFICIENCY", "0", "Default")
