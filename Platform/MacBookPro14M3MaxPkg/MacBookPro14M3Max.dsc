...
[Defines]
  ...
  PLATFORM_NAME                  = MacBookPro14M3Max
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j514c <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro14M3Max-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro14M3MaxPkg/MacBookPro14M3Max.fdf
  ...
  #   BLD_*_NTASI_T6020_J514C_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J514c SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (14-inch, M3 Max, 16 CPU cores, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J514c"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (14-inch, M3 Max, 16 CPU cores, Nov 2023) (J514c)"
  #
