# Generated by Tools/add-machine.py from Asahi's t6034-j516m.dts.
# Apple MacBook Pro (16-inch, M3 Max, 14 CPU cores, Nov 2023)
#
...
#
# @file
# stuart settings for the MacBookPro16M3Max14Core (J516m) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J516M_HOMOGENEOUS_EFFICIENCY", "0", "Default")
