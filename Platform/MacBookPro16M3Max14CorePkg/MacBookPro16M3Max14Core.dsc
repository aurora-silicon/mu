...
[Defines]
  ...
  PLATFORM_NAME                  = MacBookPro16M3Max14Core
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j516m <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro16M3Max14Core-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro16M3Max14CorePkg/MacBookPro16M3Max14Core.fdf
  ...
  #   BLD_*_NTASI_T6020_J516M_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J516m SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (16-inch, M3 Max, 14 CPU cores, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J516m"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (16-inch, M3 Max, 14 CPU cores, Nov 2023) (J516m)"
  #
