# Generated by Tools/add-machine.py from Asahi's t6031-j516c.dts.
# Apple MacBook Pro (16-inch, M3 Max, 16 CPU cores, Nov 2023)
#
...
#
# @file
# stuart settings for the MacBookPro16M3Max (J516c) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J516C_HOMOGENEOUS_EFFICIENCY", "0", "Default")
