...
[Defines]
  ...
  PLATFORM_NAME                  = MacBookPro16M3Max
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j516c <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro16M3Max-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro16M3MaxPkg/MacBookPro16M3Max.fdf
  ...
  #   BLD_*_NTASI_T6020_J516C_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6031
  ...
  # Boot Windows deterministically. The J516c SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (16-inch, M3 Max, 16 CPU cores, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J516c"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (16-inch, M3 Max, 16 CPU cores, Nov 2023) (J516c)"
  #
