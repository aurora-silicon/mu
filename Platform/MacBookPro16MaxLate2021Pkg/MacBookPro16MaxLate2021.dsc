...
[Defines]
  ...
  PLATFORM_NAME                  = MacBookPro16MaxLate2021
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j316c <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro16MaxLate2021-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro16MaxLate2021Pkg/MacBookPro16MaxLate2021.fdf
  ...
  #   BLD_*_NTASI_T6020_J316C_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J316s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (16-inch, M1 Max, 2021)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J316c"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (16-inch, M1 Max, 2021) (J316c)"
  #
