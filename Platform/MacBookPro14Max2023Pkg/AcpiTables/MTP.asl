/** @file
  J414c MTP/DockChannel input transport ACPI device.
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j414c.dts
        ...
        Device (MTP0)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    Package () { "ntasp,mtp-firmware-name", "apple/tpmtfw-j414c.bin" },
