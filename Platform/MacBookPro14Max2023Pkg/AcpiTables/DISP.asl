/** @file
  J414c internal display adapter ACPI device for the AppleDisplay WDDM
  display driver (rungs (a) and (b) of docs/j414c-display-driver.md).
  ...
  The _DSD properties are the pinned J414c geometry, provided ONLY as a
  ...
  Provenance:
    ...
    Panel 302 x 196 mm: Asahi linux-asahi t6020-j414c.dts panel node; also
