...
[Defines]
  PLATFORM_NAME                  = MacBookPro14Max2023
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j414c <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro14Max2023-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro14Max2023Pkg/MacBookPro14Max2023.fdf
  ...
  #   BLD_*_NTASI_T6020_J414C_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J414c SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (14-inch, M2 Max, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J414c"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (14-inch, M2 Max, 2023) (J414c)"
...
[Components.common]
  ...
  MacBookPro14Max2023Pkg/AcpiTables/DeviceAcpiTables.inf
