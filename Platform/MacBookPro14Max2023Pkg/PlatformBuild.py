# Generated by Tools/add-machine.py from Asahi's t6021-j414c.dts.
# Apple MacBook Pro (14-inch, M2 Max, 2023)
#
...
#
# @file
# stuart settings for the MacBookPro14Max2023 (J414c) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J414C_HOMOGENEOUS_EFFICIENCY", "0", "Default")
