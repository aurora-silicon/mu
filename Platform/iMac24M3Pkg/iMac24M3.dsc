...
[Defines]
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j434 <build>
  ...
  OUTPUT_DIRECTORY               = Build/iMac24M3-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iMac24M3Pkg/iMac24M3.fdf
  ...
  #   BLD_*_NTASI_T6020_J434_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J434 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"iMac (24-inch, 4x USB-C, M3, 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J434"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"iMac (24-inch, 4x USB-C, M3, 2023) (J434)"
  #
