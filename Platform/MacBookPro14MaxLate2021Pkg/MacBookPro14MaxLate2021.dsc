...
[Defines]
  DEFINE T600X_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacBookPro14MaxLate2021
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j314c <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro14MaxLate2021-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro14MaxLate2021Pkg/MacBookPro14MaxLate2021.fdf
  ...
  #   BLD_*_NTASI_T6020_J314C_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6001
  ...
  # Boot Windows deterministically. The J314s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (14-inch, M1 Max, 2021)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J314c"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (14-inch, M1 Max, 2021) (J314c)"
  #
