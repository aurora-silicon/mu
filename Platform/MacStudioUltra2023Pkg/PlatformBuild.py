# Generated by Tools/add-machine.py from Asahi's t6022-j475d.dts.
...
#
# @file
# stuart settings for the MacStudioUltra2023 (J475d) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J475D_HOMOGENEOUS_EFFICIENCY", "0", "Default")
