/** @file
  J475d internal display adapter ACPI device for the AppleDisplay WDDM
  display driver (rungs (a) and (b) of docs/j475d-display-driver.md).
  ...
  The _DSD properties are the pinned J475d geometry, provided ONLY as a
  ...
  Provenance:
    ...
    Panel 302 x 196 mm: Asahi linux-asahi t6020-j475d.dts panel node; also
