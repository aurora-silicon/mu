/** @file
  J475d MCA audio complex ACPI device.
  ...
  Tests/test_j475d_media_acpi_contract.py pins this file against that C table.
  ...
  tools/verify-j475d-av-adt.py asserts the address and the register count.
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t602x-j414-j416.dtsi
      (J475d GPIO overrides: SDZ pinctrl_ap 57, amp IRQ 58, jack IRQ 59)
  ...
  docs/j475d-audio-bringup.md section 8 before changing anything here.
    ...
    Scope (\_SB)
    {
        Device (MCA0)
        {
            ...
            Name (_CRS, ResourceTemplate ()
            {
                ...
                // the live ADT and tools/verify-j475d-gsiv-allocation.py
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // tools/verify-j475d-av-adt.py.  Where Apple's ADT and
                    // Asahi's hand-written Linux DT disagree, BOTH are
                    // recorded rather than one being silently preferred.
                    //
                    // Only three MCA cluster nodes are instantiated on J475d
