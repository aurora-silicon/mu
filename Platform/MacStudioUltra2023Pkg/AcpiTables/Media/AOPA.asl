/** @file
  J475d AOP (Always-On Processor) internal microphone array ACPI device.
  ...
  > wrong here.  tools/verify-j475d-av-adt.py asserts the disagreement so it
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j475d.dts:34-37
    ...
    The pinned live-ADT capture sha256 93d96b4a..., asserted by
      tools/verify-j475d-av-adt.py --section mic (51 checks)
        ...
        Device (AOPA)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    // shipped driver uses its compiled-in J475d fallback and
            ...
            // missing APDM as "use the compiled-in J475d table", records
