...
[Defines]
  DEFINE T6002_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacStudioUltra2022
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j375d <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacStudioUltra2022-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacStudioUltra2022Pkg/MacStudioUltra2022.fdf
  ...
  #   BLD_*_NTASI_T6020_J375D_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6002
  # This machine's SoC, from its device tree compatible. The family
  # package pins the base part of the family; a Max or Ultra is not it.
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Mac Studio (M1 Ultra, 2022)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J375d"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"Mac Studio (M1 Ultra, 2022) (J375d)"
  #
...
!include MacStudioFamilyPkg/MacStudioFamilyPkg.dsc.inc
!include T6002FamilyPkg/T6002FamilyPkg.dsc.inc
