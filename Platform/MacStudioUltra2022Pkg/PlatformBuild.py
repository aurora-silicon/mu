# Generated by Tools/add-machine.py from Asahi's t6002-j375d.dts.
...
# template (j475c) and have not been checked on this machine.
#
# Generated by Tools/add-machine.py from Asahi's t6021-j375d.dts.
...
#
# @file
# stuart settings for the MacStudioUltra2022 (J475c) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J375D_HOMOGENEOUS_EFFICIENCY", "0", "Default")
