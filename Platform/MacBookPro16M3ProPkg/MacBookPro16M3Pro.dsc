...
[Defines]
  DEFINE T6030_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacBookPro16M3Pro
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j516s <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro16M3Pro-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro16M3ProPkg/MacBookPro16M3Pro.fdf
  ...
  #   BLD_*_NTASI_T6020_J516S_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x6030
  ...
  # Boot Windows deterministically. The J516s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (16-inch, M3 Pro, Nov 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J516s"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (16-inch, M3 Pro, Nov 2023) (J516s)"
  #
...
!include T6030FamilyPkg/T6030FamilyPkg.dsc.inc
