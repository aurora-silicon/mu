...
[Defines]
  DEFINE T8140_SYSTEM_MEMORY_SIZE = 0x200000000
  PLATFORM_NAME                  = MacBookNeo
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j700 <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookNeo-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookNeoPkg/MacBookNeo.fdf
  ...
  #   BLD_*_NTASI_T6020_J700_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdAppleSocIdentifier|0x8140
  ...
  # Boot Windows deterministically. The J700 SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Neo"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"J700"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Neo (J700)"
  #
...
!include MacBookNeoFamilyPkg/MacBookNeoFamilyPkg.dsc.inc
!include T8140FamilyPkg/T8140FamilyPkg.dsc.inc
