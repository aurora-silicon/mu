/** @file
  J416s internal display adapter ACPI device for the AppleDisplay WDDM
  display driver (rungs (a) and (b) of docs/j416s-display-driver.md).
  ...
  The _DSD properties are the pinned J416s geometry, provided ONLY as a
  ...
  Provenance:
    ...
    Panel 302 x 196 mm: Asahi linux-asahi t6020-j416s.dts panel node; also
...
DefinitionBlock ("DISP.aml", "SSDT", 0x02, "Apple", "J416DSP", 0x00000002)
{
    Scope (\_SB)
    {
        Device (DISP)
