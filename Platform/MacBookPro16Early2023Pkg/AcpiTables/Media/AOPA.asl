/** @file
  ...
  > wrong here.  tools/verify-j416s-av-adt.py asserts the disagreement so it
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j416s.dts:34-37
    ...
    The pinned live-ADT capture sha256 93d96b4a..., asserted by
      tools/verify-j416s-av-adt.py --section mic (51 checks)
