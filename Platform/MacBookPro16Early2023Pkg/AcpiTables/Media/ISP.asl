/** @file
  J416s (M2 Pro / T6020) FaceTime camera ISP coprocessor ACPI device.
  ...
  Tests/test_j416s_media_acpi_contract.py machine-checks that the _CRS window
  ...
  does not silently break the camera.  tests/test_j416s_av_memory_contract.py
  pins it.

  Provenance:
    Linux arch/arm64/boot/dts/apple/t602x-die0.dtsi:562-578 (isp@384000000)
    Linux arch/arm64/boot/dts/apple/t602x-j416-j416.dtsi:146-152
    ...
    the pinned J416s live ADT capture, sha256 93d96b4a...
    docs/j416s-camera-isp-bringup.md

  SPDX-License-Identifier: MIT
**/

DefinitionBlock ("ISP.aml", "SSDT", 0x02, "Apple", "J416ISP", 0x00000001)
{
    Scope (\_SB)
    {
        Device (ISP0)
        {
            ...
            // they exist so that tools/verify-j416s-av-adt.py and a human
