 ...
 *     for the base MacBook Pro (16-inch, Early 2023) platform.
 ...
 DefinitionBlock("DSDT.aml", "DSDT", 0x02, "Apple", "J41x", 0x6020) {
    Scope(\_SB) {
        ...
        Device (PCI0) {
            ...
            // live J416s ADT capture (j416s-adt.bin, sha256
        ...
        //
        // J416s' right-side USB-C receptacle is usb-drd2.  Keep its native
