/** @file
  J416s SMC GPIO controller (NTAS0052).
  ...
  SoC pin controller:
    ...
    t602x-j416-j416.dtsi:125  apple,afe-reset-gpios = <&smc_gpio 25 ...>
    t602x-j416-j416.dtsi:126  apple,stm-reset-gpios = <&smc_gpio 26 ...>
