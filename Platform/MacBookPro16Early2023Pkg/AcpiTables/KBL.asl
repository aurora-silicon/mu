/** @file
  J416s internal keyboard backlight (FPWM) ACPI device.

  The keyboard backlight on the MacBook Pro 14" (M2 Pro, J416s) is channel 0
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t602x-j416-j416.dtsi (includes the above
      for J416s/J416s)
...
DefinitionBlock ("KBL.aml", "SSDT", 0x02, "Apple", "J416KBL", 0x00000001)
{
    Scope (\_SB)
    {
        Device (KBL0)
