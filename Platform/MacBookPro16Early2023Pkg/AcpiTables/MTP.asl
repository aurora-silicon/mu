/** @file
  J416s MTP/DockChannel input transport ACPI device.
  ...
  Provenance:
    ...
    Linux arch/arm64/boot/dts/apple/t6020-j416s.dts
    m1n1 proxyclient/experiments/mtp.py

  SPDX-License-Identifier: MIT
**/

DefinitionBlock ("MTP.aml", "SSDT", 0x02, "Apple", "J416MTP", 0x00000001)
{
    Scope (\_SB)
    {
        //
        ...
        Device (MTP0)
        {
            ...
            Name (_DSD, Package ()
            {
                ...
                Package ()
                {
                    ...
                    Package () { "ntasp,mtp-firmware-name", "apple/tpmtfw-j416s.bin" },
