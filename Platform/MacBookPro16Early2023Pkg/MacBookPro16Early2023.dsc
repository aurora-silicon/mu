...
[Defines]
  PLATFORM_NAME                  = MacBookPro16Early2023
  ...
  #   NTASI_DEPLOY_EVIDENCE_ECHO=1 ./Tools/build-windows-native.sh j416s <build>
  ...
  OUTPUT_DIRECTORY               = Build/MacBookPro16Early2023-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MacBookPro16Early2023Pkg/MacBookPro16Early2023.fdf
  ...
  #   BLD_*_NTASI_T6020_J416S_HOMOGENEOUS_EFFICIENCY=1
...
[PcdsFixedAtBuild.common]
  ...
  # Boot Windows deterministically. The J416s SSD dual-boots Fedora, whose
  ...
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModel|"MacBook Pro (16-inch, Early 2023)"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemModelNumber|"Mac14,10"
  gAppleSiliconPkgTokenSpaceGuid.PcdSmbiosSystemSku|"MacBook Pro (16-inch, Early 2023) (Mac14,10)"
...
[Components.common]
  ...
  MacBookPro16Early2023Pkg/AcpiTables/DeviceAcpiTables.inf
