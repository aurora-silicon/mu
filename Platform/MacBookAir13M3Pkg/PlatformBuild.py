# Generated by Tools/add-machine.py from Asahi's t8122-j613.dts.
...
#
# @file
# stuart settings for the MacBookAir13M3 (J613) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J613_HOMOGENEOUS_EFFICIENCY", "0", "Default")
