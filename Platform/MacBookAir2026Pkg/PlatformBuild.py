...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("MacBookAir2026Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('MacBookAir2026', 'gcc_aarch64_linux')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("MacBookAir2026Pkg/MacBookAir2026.dsc", {})

    def GetName(self):
        return "MacBookAir2026"
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "MacBookAir2026Pkg/MacBookAir2026.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "MacBookAir2026", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "MacBookAir2026Pkg/MacBookAir2026.dsc", "Platform Hardcoded")
