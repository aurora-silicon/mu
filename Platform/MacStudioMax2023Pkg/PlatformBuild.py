# Generated by Tools/add-machine.py from Asahi's t6021-j475c.dts.
...
#
# @file
# stuart settings for the MacStudioMax2023 (J475c) platform.
#
...
class PlatformBuilder(ApplePlatformBuilder, UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # asks otherwise.
        self.env.SetValue(
            "BLD_*_NTASI_T6020_J475C_HOMOGENEOUS_EFFICIENCY", "0", "Default")
